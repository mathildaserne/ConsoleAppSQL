    ...
    class SQL
    {
...

        {
            ...
            if (!fi.Exists || fi.Length == 0)
            {
                ...
                ExecuteSQL(@"CREATE TABLE ""Tenant""(""ID"" INTEGER,""LGH NR"" INTEGER, ""PERSON"" TEXT,""TAGG"" TEXT");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('101', 'Liam Jönsson', '0101A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('102', 'Elias Petterson', '0102A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('102', 'Wilma Johansson', '0102B'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('103', 'Alicia Sanchez', '0103A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('103', 'Aaron Sanchez ', '0103B'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('201', 'Olivia Erlander', '0201A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('201', 'William Erlander', '0201B'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('201', 'Alexander Erlander', '0201C'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('201', 'Astrid Erlander', '0201D'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('202', 'Lucas Adolfsson', '0202A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('202', 'Ebba Adolfsson', '0202B'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('202', 'Lilly Adolfsson', '0202C'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('301', 'Ella Ahlström', '0301A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('301', 'Alma Alfredsson', '0301B'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('301', 'Elsa Ahlström', '0301C'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('301', 'Maja Ahlström', '0301D'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('302', 'Noah Almgren', '0302A'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('302', 'Adam Andersen', '0302B'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('302', 'Kattis Backman', '0302C'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('302', 'Oscar Chen', '0302D'");
                ExecuteSQL(@"INSERT INTO ""Tenant""(""LGH NR"", ""PERSON"", ""TAGG"") VALUES('VAKT', 'Vaktmästare', 'VAKT01'");

                ExecuteSQL(@"CREATE TABLE ""Main""(""DatumTid""  INTEGER,""Location"" INTEGER,""Kod"" INTEGER,""Tagg"" INTEGER,""Tenant"" INTEGER");
